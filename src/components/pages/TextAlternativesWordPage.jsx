  ...
  return (
    ...
    >
      ...
      <AltTextComparisonTable rows={[
        { image: "Line graph in economics lecture", poor: '"graph"', better: "Line graph showing U.S. unemployment rate declining from 14.7% in April 2020 to 3.4% in January 2023" },
        { image: "Photo of campus building on syllabus", poor: '"building photo"', better: "Mark as decorative (does not convey course content)" },
        { image: "Screenshot of LMS assignment settings", poor: '"screenshot"', better: "Canvas assignment settings showing Due Date set to March 15 and Available Until set to March 22" },
        { image: "Logo at top of department letterhead", poor: '"logo"', better: 'Mark as decorative, or "Rutgers SCI logo" if identification matters in context' },
      ]} />
